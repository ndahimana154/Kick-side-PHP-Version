                                        ...
                                        <div class="form-row">
                                            <form action="" method="POST" enctype="multipart/form-data">
                                                ...
                                                <p>
                                                    ...
                                                    <textarea name="title" placeholder="Type..." required><?php echo $dataCheckArticles['article_title']; ?></textarea>
                                                </p>
                                                ...
                                                <p>
                                                    ...
                                                    <textarea name="overview"  placeholder="Type..." required><?php echo $dataCheckArticles['article_overview']; ?></textarea>
                                                </p>
                                                <p>
                                                    <label for="Article Overview">
                                                        Article in Details
                                                    </label>
                                                    <textarea name="details"  placeholder="Type..." class="full" required><?php echo $dataCheckArticles['article_full_details']; ?></textarea>
                                                </p>
                                                <p>
