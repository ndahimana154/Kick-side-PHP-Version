...
<head>
   ...
   <title>KickSide || Articles List</title>
</head>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       ...
                                       if (mysqli_num_rows($check_if_categories_exists) < 1) {
                                          ?>
                                          <a href="article-add-category.php?a=<?php echo $data_All_articles['article_id']; ?>"
                                    ...
                                    <td>
                                       <button class="deleteArticle delete"
                                          value="<?php echo $data_All_articles['article_id']; ?>" title="Delete article.">
                                          <i class="fa fa-trash"></i>
                                       </button>
                                       <a href="../clients/read.php?a=<?php echo $data_All_articles['article_id']; ?>"
                                          target="_blank" title="Watch the Article live">
                                          <i class="fa fa-eye"></i>
                                       </a>
                                    </td>
                                 </tr>
